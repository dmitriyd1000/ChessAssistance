...
using Emgu.CV.Util;
using static DarkNetYoloNET.Models.PreferredBackend;
using static DarkNetYoloNET.Models.PreferredTarget;

namespace DarkNetYoloNET
{
    ...
    public class DarknetYOLO
    {
        ...
        public DarknetYOLO(string labelsPath = @".\labels.names", string weightsPath=@".\yolov4-tiny-customBW_best.weights",
            string configPath=@".\yolov4-tiny-customBW.cfg", Emgu.CV.Dnn.Backend backend = Emgu.CV.Dnn.Backend.OpenCV, Emgu.CV.Dnn.Target target = Emgu.CV.Dnn.Target.Cpu)
        {
